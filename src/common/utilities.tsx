...
export function getOrdinalNumber(n: any) {
...
export function calculatePositionWithGutter(rect: any, objectWidth: any, viewportWidth: any, gutter = 24) {
...
export function calculatePositionWithGutterById(id: any, objectWidth: any, viewportWidth: any, gutter?: any) {
  let rect;
  if (id) {
...
export function leftPad(input: any, length: any) {
