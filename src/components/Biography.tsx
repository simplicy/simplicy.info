...
export default function Biography() {
  ...
  const [game, setGame] = useState(playing ? playing[0]?.name : "Not Playing");
  const [gametime, setGametime] = useState(playing ? Math.round(playing[0]?.playtime_forever / 60) + " hours" : "");
  const [song, setSong] = useState("Not Listening");
  // let location = "USA";

  useEffect(() => {
    setGame(playing && playing.length > 0 ? playing[0].name : "Not Playing");
	...
	C56,10.746,45.254,0,32,0z M32,32c-4.418,0-8-3.582-8-8s3.582-8,8-8s8,3.582,8,8S36.418,32,32,32z"/>
        ...
        <div style={{
          ...
          <div className={styles.nowplaying}>
            ...
            <p id="game" className="scramble" title={game}>000000000000000000</p>
